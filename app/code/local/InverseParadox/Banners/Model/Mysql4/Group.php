...
class InverseParadox_Banners_Model_Mysql4_Group extends Mage_Core_Model_Mysql4_Abstract
{
	public function _construct()
	{
		$this->_init('ipbanners/group', 'group_id');
	}
	 ...
	 *
	 * @param InverseParadox_Banners_Model_Group $group
	 * @return InverseParadox_Banners_Model_Mysql4_Banner_Collection
	 */
	public function getBannerCollection(InverseParadox_Banners_Model_Group $group, $includeDisabled = false)
	{
		$banners = Mage::getResourceModel('ipbanners/banner_collection')
	...
	{
		if (!$object->getCode()) {
			throw new Exception(Mage::helper('ipbanners')->__('Banner group must have a unique code'));
		}
